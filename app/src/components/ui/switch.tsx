...
function Switch({
  ...
  const thumbColor = colorScheme === 'dark' && props.checked ? theme.background : '#FFFFFF';
  return (
    <SwitchPrimitives.Root
      ...
      <SwitchPrimitives.Thumb
        style={{ width: 16, height: 16, borderRadius: 8, borderWidth: 1, borderColor: `${theme.textSecondary}99`, backgroundColor: thumbColor, position: 'absolute', top: 2, left: props.checked ? 16 : 2 }}
