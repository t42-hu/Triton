...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        'bg-card border border-foreground/50 flex h-[44px] flex-row items-center justify-center gap-1 rounded-xl p-1',
    ...
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        className={cn(
          ...
          props.value === value ? 'border-primary bg-primary' : 'bg-transparent active:bg-accent',
          className
        )}
        {...props}
      />
